      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative rounded-3xl p-8 md:p-12 lg:p-16 border border-border/50 backdrop-blur-sm">
          ...
          >
            ...
            <Text variant="body-lg" color="secondary" className="text-lg sm:text-xl max-w-2xl text-center">
              Powerful tools for organizing trips, managing timelines, and tracking expenses - all in one place.
            </Text>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/trips">
                <Button size="lg" className="px-10 py-5 text-lg font-medium bg-[#B0703C] text-primary-foreground hover:bg-[#B0703C]/90 rounded-full">
                  Start Planning Now
                  <span className="ml-2 text-[22px] leading-none relative top-[1px]">↗</span>
                </Button>
              </Link>
              <Link href="/about">
                <Button size="lg" variant="outline" className="px-10 py-5 text-lg font-medium border-2 rounded-full">
                  View Sample Trips
                  <span className="ml-2 text-[22px] leading-none relative top-[1px]">↗</span>
                </Button>
              </Link>
