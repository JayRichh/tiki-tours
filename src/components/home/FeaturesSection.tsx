...
function FeatureCard({ feature, index }: { feature: Feature; index: number }) {
  ...
  return (
    <motion.div ref={cardRef} style={{ y, opacity }} className="relative w-full">
      <div className="group relative h-full overflow-hidden">
        ...
        <div className="relative p-8 md:p-10">
          <div className="mb-8 flex items-center gap-4">
            ...
            <Text
              variant="h3"
              className="text-2xl font-semibold bg-gradient-to-r from-[hsl(28,85%,35%)] to-[hsl(35,85%,45%)] bg-clip-text text-transparent"
            >
              {feature.title}
            </Text>
          </div>

          <Text className="mb-8 text-lg text-foreground/80">{feature.description}</Text>
            ...
            {feature.details.map((detail, i) => (
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <Text className="font-medium text-foreground/90 mb-1">{detail.title}</Text>
...
export function FeaturesSection() {
  ...
  return (
    <section className="w-full relative overflow-hidden min-h-screen" ref={containerRef}>
      {/* Background Effects */}
      ...
      <div className="relative space-y-24 w-full mx-auto px-6 md:px-8 lg:px-10 max-w-7xl py-24 mt-24">
        ...
        >
          ...
          >
            Everything you need to organize trips, manage budgets, and track travel plans in one
            place
          </Text>
        </motion.div>
